...
export const LANDING_I18N: Record<Language, Record<string, string>> = {
  en: {
    ...
    'support.title': 'Need help before you buy or while you set things up?',
    'support.description': 'Talk directly to our team and get fast help with licensing, billing, onboarding, or product questions.',
    'support.email_label': 'Support email',
    'support.footer_link': 'Support',
    'roadmap.title': 'Roadmap',
    'roadmap.subtitle': 'See what we are building and what is coming next.',
    'roadmap.support_copy': 'Questions about the roadmap or a feature request? Reach us at',
    ...
    'roadmap.collapse': 'Collapse roadmap',
    'roadmap.expand': 'Expand roadmap',
  ...
  'pt-BR': {
    ...
    'support.title': 'Precisa de ajuda antes da compra ou na configuracao?',
    'support.description': 'Fale direto com o time para resolver licenca, cobranca, onboarding ou duvidas de produto com mais rapidez.',
    'support.email_label': 'Email de suporte',
    'support.footer_link': 'Suporte',
    'roadmap.title': 'Roadmap',
    'roadmap.subtitle': 'Veja o que estamos construindo e o que vem a seguir.',
    'roadmap.support_copy': 'Tem duvida sobre o roadmap ou quer pedir um recurso? Fale com a gente em',
    ...
    'roadmap.collapse': 'Recolher roadmap',
    'roadmap.expand': 'Expandir roadmap',
